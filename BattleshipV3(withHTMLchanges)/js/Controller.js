...
class Controller {
    ...
    _numPlayers = 2;   //Hold number of players
    ...
    //Game setup
    setUp() {
        cout("Entered setUp",endl);
        cout(this._numPlayers,endl);
        //Loop for two players
        for (let i = 0; i < this._numPlayers; i++) {
            let coords = new Array(2); //Hold input coordinates
            ...
            this._players[i] = new PlayerData();
            //Set Player name
