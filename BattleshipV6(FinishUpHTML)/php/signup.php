        ...
        if (isset($jsondata["type"])) {
            switch ($jsondata["type"]) {
                case "test":
                    ...
                    break;
                case "usersignup":
                    if (isset($jsondata["username"]) && isset($jsondata["firstname"]) && isset($jsondata["lastname"]) && isset($jsondata["password"])) {
                        BSDatabase::StartConnection();
                        $result = BSDatabase::Register($jsondata["username"], $jsondata["firstname"], $jsondata["lastname"], $jsondata["password"]);
